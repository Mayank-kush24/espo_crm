<?php return array (
  ...
  array (
    ...
    array (
      ...
      1 => 
      array (
        'regex' => '~^(?|/espocrm/api/v1/MassAction/([^/]+)/status|/espocrm/api/v1/Export/([^/]+)/status()|/espocrm/api/v1/Kanban/([^/]+)()()|/espocrm/api/v1/Attachment/file/([^/]+)()()()|/espocrm/api/v1/Note/([^/]+)/reactors/([^/]+)()()()|/espocrm/api/v1/User/([^/]+)/stream/own()()()()()|/espocrm/api/v1/User/([^/]+)/acl()()()()()()|/espocrm/api/v1/([^/]+)/([^/]+)()()()()()()|/espocrm/api/v1/([^/]+)()()()()()()()())$~',
        'routeMap' => 
        array (
          2 => 
          array (
      ...
      2 => 
      array (
        'regex' => '~^(?|/espocrm/api/v1/([^/]+)/([^/]+)/followers|/espocrm/api/v1/([^/]+)/([^/]+)/stream()|/espocrm/api/v1/([^/]+)/([^/]+)/posts()()|/espocrm/api/v1/([^/]+)/([^/]+)/updateStream()()()|/espocrm/api/v1/([^/]+)/([^/]+)/streamAttachments()()()()|/espocrm/api/v1/([^/]+)/([^/]+)/usersAccess()()()()()|/espocrm/api/v1/([^/]+)/([^/]+)/([^/]+)()()()()())$~',
        'routeMap' => 
        array (
          3 => 
          array (
